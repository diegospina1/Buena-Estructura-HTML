...
form.addEventListener('change', (e) => {
    ...
    switch(inputId){
        ...
        case "celphone":
            ...
            formValid.celPhone = valueInput.match(cellRx) ? true : false;
            formValid.celPhone ? isValidClass() : isInvalidClass();
            console.log(Object.values(formValid)); 
            break;
        case "checkPolitica":
            const checkp = document.getElementById('checkPolitica');
            formValid.politica = valueInput.match(checkp.style) ? true : false;
